...
async function main(){
  ...
  const statusDefs=[['READY','Sẵn sàng','#64748b',true,true,false],['IN_USE','Đang sử dụng','#16803c',false,true,false],['RESERVED','Đã giữ chỗ','#a16207',false,false,false],['MAINTENANCE','Bảo trì','#c56a00',false,false,false],['LOST','Mất','#c62828',false,false,false],['BROKEN','Hỏng','#dc2626',false,false,false],['DISPOSED','Thanh lý','#475569',false,false,true]] as const
  const statuses=[]
