...
const columns = [
  'Mã tài sản', 'Tên tài sản', 'Nhóm tài sản', 'Serial / IMEI',
  'Phòng ban', 'Kho / Vị trí', 'Người sử dụng (bỏ qua khi nhập kho)',
  'Trạng thái (bỏ qua khi nhập kho)', 'Ngày mua (YYYY-MM-DD)',
  'Nguyên giá (VNĐ)', 'Hãng sản xuất', 'Model', 'CPU', 'RAM',
  'Ổ đĩa', 'Hệ điều hành', 'Địa chỉ IP', 'Địa chỉ MAC', 'Ảnh tài sản (URL)'
]
