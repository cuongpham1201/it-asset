...
const viToEn: Array<[string,string]> = [
  ...
  ['Tài khoản quản trị ban đầu được tạo trong quá trình cài đặt hệ thống.','The initial administrator account is created during system installation.'],
  ...
  ['Khai báo đầy đủ hồ sơ và cấu hình trước khi ghi nhận vào kho.','Complete the asset record and configuration before receiving it into stock.'],
  ['Import template Excel','Import Excel template'],
  ['Import tài sản từ template Excel','Import assets from an Excel template'],
  ['Nhập hàng loạt tài sản bằng template Excel chuẩn của hệ thống.','Bulk receive assets using the system Excel template.'],
  ['Dùng khi tiếp nhận nhiều tài sản trong cùng một đợt nhập kho.','Use this when receiving multiple assets in one stock receipt.'],
  ...
  ['Mã tài sản và Tên tài sản là bắt buộc; mỗi dòng là một tài sản.','Asset code and Asset name are required; each row represents one asset.'],
  ['Chọn file để nhập kho','Choose the receipt file'],
  ['Hệ thống kiểm tra mã trùng và nguyên giá trước khi ghi nhận.','The system checks duplicate codes and purchase cost before importing.'],
  ...
  ['Quét Barcode hoặc QR để tra cứu tài sản và lập hồ sơ nhập kho.','Scan a Barcode or QR code to find an asset and prepare its receipt record.'],
  ['Đưa Barcode hoặc QR Code vào camera, dùng máy quét USB hoặc nhập mã thủ công.','Show a Barcode or QR code to the camera, use a USB scanner, or enter the code manually.'],
  ...
  ['Chọn loại mã phù hợp với thiết bị quét của đơn vị.','Choose the code type that matches your organization’s scanners.'],
  ['Barcode','Barcode'],
  ['QR Code','QR Code'],
  ['Cả hai','Both'],
