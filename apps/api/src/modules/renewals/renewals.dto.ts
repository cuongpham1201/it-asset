...
import { IsArray,IsBoolean,IsDateString,IsEmail,IsEnum,IsInt,IsNotEmpty,IsNumber,IsOptional,IsString,IsUUID,Max,MaxLength,Min } from 'class-validator'
...
export class RevokeAssignmentDto{@IsString() @IsNotEmpty() @MaxLength(5000) reason!:string}
...
export class AcknowledgeAlertDto{@IsOptional() @IsString() @MaxLength(5000) note?:string}
...
export class TestRenewalEmailDto{@IsEmail() recipient!:string}
