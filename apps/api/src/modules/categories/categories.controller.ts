...
export class CategoriesController{
  ...
  @Patch(':id') update(@Param('id',ParseUUIDPipe) id:string,@Body() body:UpdateAssetCategoryDto,@Req() req:AuthRequest){this.categories.assertAdmin(req.authUser);return this.categories.update(id,body,req.authUser)}
}
