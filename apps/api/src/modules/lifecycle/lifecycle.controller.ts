...
export class LifecycleController{
  ...
  @Post('assets/:id/transfers') transfer(@Param('id',ParseUUIDPipe) id:string,@Body() body:TransferAssetDto,@Req() req:AuthRequest){return this.lifecycle.transfer(id,body,req.authUser)}
  @Post('assets/:id/maintenance') openMaintenance(@Param('id',ParseUUIDPipe) id:string,@Body() body:OpenMaintenanceDto,@Req() req:AuthRequest){return this.lifecycle.openMaintenance(id,body,req.authUser)}
  @Post('maintenance/:id/complete') completeMaintenance(@Param('id',ParseUUIDPipe) id:string,@Body() body:CompleteMaintenanceDto,@Req() req:AuthRequest){return this.lifecycle.completeMaintenance(id,body,req.authUser)}
}
