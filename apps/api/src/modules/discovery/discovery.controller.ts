...
export class AgentIngestionController{
  ...
  @Public() @Post('enroll') enroll(@Headers('authorization') authorization:string|undefined,@Body() body:AgentInventoryDto){return this.discovery.enroll(authorization,body)}
  @Public() @Post('inventory') inventory(@Headers('authorization') authorization:string|undefined,@Body() body:AgentInventoryDto){return this.discovery.ingest(authorization,body)}
}
...
export class DiscoveryController{
  constructor(private readonly discovery:DiscoveryService){}
  @Get('summary') summary(@Req() req:AuthRequest){return this.discovery.summary(req.authUser)}
  @Get('inbox') list(@Query() query:ListDiscoveryQuery,@Req() req:AuthRequest){return this.discovery.list(query,req.authUser)}
  @Get('inbox/:id') get(@Param('id',ParseUUIDPipe) id:string,@Req() req:AuthRequest){return this.discovery.get(id,req.authUser)}
  @Post('inbox/:id/link') link(@Param('id',ParseUUIDPipe) id:string,@Body() body:LinkDiscoveryDto,@Req() req:AuthRequest){return this.discovery.link(id,body,req.authUser)}
  @Post('inbox/:id/create-asset') createAsset(@Param('id',ParseUUIDPipe) id:string,@Body() body:CreateAssetFromDiscoveryDto,@Req() req:AuthRequest){return this.discovery.createAsset(id,body,req.authUser)}
  ...
  @Delete('agents/:id') revokeAgent(@Param('id',ParseUUIDPipe) id:string,@Req() req:AuthRequest){return this.discovery.revokeAgent(id,req.authUser)}
}
